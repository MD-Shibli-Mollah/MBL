* @ValidationCode : MjoxNjUxNTI3MTY1OkNwMTI1MjoxNjMyOTkyMzMxMzc4OnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 30 Sep 2021 14:58:51
...
*
    ...
    Y.CRD.REQ.REC.STATUS =REC.CRD.REQ<DEBIT.CARD.RECORD.STATUS>
*
    Y.REC.STATUS = EB.SystemTables.getRNew(DEBIT.CARD.RECORD.STATUS)
    Y.CURR1 = EB.SystemTables.getRNew(DEBIT.CARD.CURR.NO)
...
*    FileName = 'SHIBLI_Crd_SEP.30.21.txt'
*    FilePath = 'DL.BP'
