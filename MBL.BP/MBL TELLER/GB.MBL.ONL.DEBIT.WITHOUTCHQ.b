* @ValidationCode : MjoxMjg5MzUyODYwOkNwMTI1MjoxNjI3Mjg0NjYzNDg0OnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Jul 2021 13:31:03
...
*                                                     FDS Pvt Ltd
*
* Modification History 2: CATEGORY CHECK ADDED FOR TELLER
*
...
*-------------------ADDED CODE FOR COB----------first 3 digit OF Inward Pay Type "RC-"-------return----------
        Y.IN.PAY = EB.SystemTables.getRNew(FT.Contract.FundsTransfer.InwardPayType)
        Y.IN.PAY.STR3 = Y.IN.PAY[1,3]
        IF Y.IN.PAY.STR3 EQ "RC-" THEN
            RETURN
        END
*--------------------------END-------------------------------------------------------------------------------
        IF Y.DEBIT.AC[1,2] EQ 'PL' THEN
...
*--------------------------WRITE DATA---------------------------------
*            WriteData = "FT.TRANSACTION.TYPE: ":Y.FT.TRANSACTION.TYPE:" VERSION: ":Y.VERSION:" PGM: ":Y.PGM:" DEBIT.AC: ":Y.DEBIT.AC:" CHQ.NO: ":Y.CHQ.NO:" CO.CODE: ":Y.CO.CODE:" AC.LIST: ":Y.AC.LIST
*            FileName = 'SHIBLI_FT.COB.TEST.txt'
*            FilePath = 'DL.BP'
...
*            EB.SystemTables.setText("CHEQUE NO. IS MANDATORY FOR ONLINE AC")
