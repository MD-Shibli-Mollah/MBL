* @ValidationCode : MjotMTk5ODI4MTAyNjpDcDEyNTI6MTU5OTk3Nzc0NzA2Njp1c2VyOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMTcxMC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Sep 2020 12:15:47
...
***********
    IF Y.SEL.CO NE '' THEN
        SEL.CMD.LD = "SELECT ":FN.AA.RETAIL:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'ACCOUNTS...' AND CO.CODE EQ ":Y.SEL.CO
    END
    ELSE
        SEL.CMD.LD = "SELECT ":FN.AA.RETAIL:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'ACCOUNTS...' AND CO.CODE EQ ":Y.COMPANY
    END
...
************
    ...
    !AA.DEPOSIT.RECORD: " WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'DEPOSITS...'
***********
    IF Y.SEL.CO NE '' THEN
* SEL.CMD.DEP = "SELECT ":FN.AA.DEPOSIT:" WITH ACTIVITY LIKE 'DEPOSITS...' AND ACTIVITY UNLIKE '...VIEW-ARRANGEMENT' AND TXN.SYSTEM.ID NE 'FT' AND TXN.SYSTEM.ID NE 'TT' AND TXN.SYSTEM.ID NE 'AC' AND CO.CODE EQ ":Y.SEL.CO
        SEL.CMD.DEP = "SELECT ":FN.AA.DEPOSIT:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'DEPOSITS...' AND CO.CODE EQ ":Y.SEL.CO
    END
    ELSE
        SEL.CMD.DEP = "SELECT ":FN.AA.DEPOSIT:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'DEPOSITS...' AND CO.CODE EQ ":Y.COMPANY
    END
...
************
    ...
    !AA.LENDING.RECORD: " WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'LENDING...'
***********
    IF Y.SEL.CO NE '' THEN
*  SEL.CMD.LEN = "SELECT ":FN.AA.LENDING:" WITH ACTIVITY LIKE 'LENDING...' AND ACTIVITY UNLIKE '...VIEW-ARRANGEMENT' AND TXN.SYSTEM.ID NE 'FT' AND TXN.SYSTEM.ID NE 'TT' AND TXN.SYSTEM.ID NE 'AC' AND CO.CODE EQ ":Y.SEL.CO
        SEL.CMD.LEN = "SELECT ":FN.AA.LENDING:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'LENDING...' AND CO.CODE EQ ":Y.SEL.CO
    END
    ELSE
        SEL.CMD.LEN = "SELECT ":FN.AA.LENDING:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'LENDING...' AND CO.CODE EQ ":Y.COMPANY
    END
