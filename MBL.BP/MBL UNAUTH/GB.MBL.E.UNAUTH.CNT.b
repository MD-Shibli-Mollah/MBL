* @ValidationCode : MjozMTg2MzU5MDI6Q3AxMjUyOjE1OTk5ODAyMjE0Njg6dXNlcjotMTotMTowOjA6ZmFsc2U6Ti9BOkRFVl8yMDE3MTAuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Sep 2020 12:57:01
...
****************************AA**********************************
***" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'LENDING...'***
    SEL.CMD.RETAIL = "SELECT ":FN.AA.RET:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'ACCOUNTS...' AND CO.CODE EQ ":Y.COMPANY
...
* SEL.CMD.DEP = "SELECT ":FN.AA.DEP:" WITH RECORD.STATUS EQ INAU AND TXN.SYSTEM.ID NE 'FT' AND TXN.SYSTEM.ID NE 'TT' AND TXN.SYSTEM.ID NE 'AC' AND ACTIVITY LIKE 'DEPOSIT...' AND ACTIVITY UNLIKE '...VIEW-ARRANGEMENT' AND CO.CODE EQ ":Y.COMPANY
    SEL.CMD.DEP = "SELECT ":FN.AA.DEP:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'DEPOSITS...' AND CO.CODE EQ ":Y.COMPANY
    EB.DataAccess.Readlist(SEL.CMD.DEP,SEL.CMD.LIST.DEP,'',NO.OF.REC.DEP,RET.CODE.DEP)
*
    SEL.CMD.LD = "SELECT ":FN.AA.LD:" WITH @ID LIKE '...VIEW-ARRANGEMENT' AND ACTIVITY LIKE 'LENDING...' AND CO.CODE EQ ":Y.COMPANY
