* @ValidationCode : MjoxMjcwNzgyMDQ3OkNwMTI1MjoxNTk2NzA3MTEwMzE2OnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Aug 2020 15:45:10
...
SUBROUTINE TF.MBL.E.NOF.LC.CASH(Y.RETURN)
*PROGRAM E.LC.CASH
    $INSERT  I_COMMON
    $INSERT  I_EQUATE
...
*Y.CUS.NAME = R.LC<TF.LC.APPLICANT,1>
            ...
            Y.CUS.NO = R.LC<LC.Contract.LetterOfCredit.TfLcApplicantCustno>
            Y.COUNT='1'
            Y.COUNT.OUT.BAL='1'
...
*Y.CUS.NAME = R.LC.HIS<TF.LC.APPLICANT,1>
        ...
        Y.CUS.NO = R.LC.HIS<LC.Contract.LetterOfCredit.TfLcApplicantCustno>
