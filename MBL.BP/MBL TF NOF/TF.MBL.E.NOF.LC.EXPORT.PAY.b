* @ValidationCode : MjoyMDA5NDE4ODE1OkNwMTI1MjoxNTk2NzA2MjExNTcxOnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Aug 2020 15:30:11
...
SUBROUTINE TF.MBL.E.NOF.LC.EXPORT.PAY(Y.RETURN)
*PROGRAM E.LC.EXPORT.PAY
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*---------
    ...
    IF Y.CUS.NO EQ '' AND Y.FROM.DATE NE '' AND Y.TO.DATE NE '' THEN
        ...
        WRITE.FILE.VAR = SEL.CMD
* GOSUB * FILE.WRITE
        WRITE.FILE.VAR = SEL.LIST
* GOSUB * FILE.WRITE
        WRITE.FILE.VAR = NO.OF.REC
* GOSUB * FILE.WRITE
        
    END
    ELSE IF Y.CUS.NO NE '' AND Y.FROM.DATE EQ '' AND Y.TO.DATE EQ '' THEN
        SEL.CMD ='SELECT ':FN.DR :' WITH LC.CREDIT.TYPE EQ ':Y.TYPE:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND  LT.TF.APL.CUSNO EQ ':Y.CUS.NO:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY BY LT.TF.DT.PAYMNT'
        EB.DataAccess.Readlist(SEL.CMD,SEL.LIST,'',NO.OF.REC,RET.CODE)
        WRITE.FILE.VAR = SEL.CMD
* GOSUB * FILE.WRITE
        WRITE.FILE.VAR = SEL.LIST
...
* GOSUB * FILE.WRITE
    ...
    END
    ELSE
        SEL.CMD ='SELECT ':FN.DR :' WITH LC.CREDIT.TYPE EQ ':Y.TYPE:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY BY LT.TF.DT.PAYMNT'
        EB.DataAccess.Readlist(SEL.CMD,SEL.LIST,'',NO.OF.REC,RET.CODE)
        WRITE.FILE.VAR = SEL.CMD
* GOSUB * FILE.WRITE
        WRITE.FILE.VAR = SEL.LIST
...
*------------
    ...
    END
    ELSE IF Y.CUS.NO NE '' AND Y.FROM.DATE EQ '' AND Y.TO.DATE EQ '' THEN
        SEL.HIS.DATA ='SELECT ':FN.DR.HIS :' WITH  (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND DRAW.CURRENCY EQ ':Y.LC.CURR:' AND LC.CREDIT.TYPE EQ ':Y.LC.TYPE:' AND CO.CODE EQ ':Y.COMPANY:' AND  LT.TF.APL.CUSNO EQ ':Y.CUS.NO:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY BY LT.TF.DT.PAYMNT BY-DSND @ID'
        EB.DataAccess.Readlist(SEL.HIS.DATA,SEL.LIST.HIS,'',NO.OF.HIS.REC,HIS.ERR)
    END
    ELSE
        SEL.HIS.DATA ='SELECT ':FN.DR.HIS :' WITH (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND DRAW.CURRENCY EQ ':Y.LC.CURR:' AND LC.CREDIT.TYPE EQ ':Y.LC.TYPE:' AND CO.CODE EQ ':Y.COMPANY:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY BY LT.TF.DT.PAYMNT BY-DSND @ID'
        EB.DataAccess.Readlist(SEL.HIS.DATA,SEL.LIST.HIS,'',NO.OF.HIS.REC,HIS.ERR)
    END
...
*-----------------
    ...
    END
    ELSE
        SEL.HIS.DATA ='SELECT ':FN.DR.HIS :' WITH (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND LC.CREDIT.TYPE EQ ':Y.TYPE:' AND CO.CODE EQ ':Y.COMPANY:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY BY LT.TF.DT.PAYMNT BY-DSND @ID'
        EB.DataAccess.Readlist(SEL.HIS.DATA,SEL.LIST.HIS,'',NO.OF.HIS.REC,HIS.ERR)
    END
    LOOP
        REMOVE Y.LC.HIS.ID FROM SEL.LIST.HIS SETTING POS2
