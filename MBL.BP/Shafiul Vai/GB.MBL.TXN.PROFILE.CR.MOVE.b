* @ValidationCode : MjotNzgxOTAzNTAwOkNwMTI1MjoxNTk1NDgxOTE3OTg1OkRFTEw6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 Jul 2020 11:25:17
...
***********Write TP Transaction Information Data Into BD.TXN.PROFILE.ENTRY***************
    ...
    IF  NOT(R.TP.REC) THEN
        IF Y.SYS.ID EQ 'FT' THEN
            Y.OR.ID = 'EB-MBL.TP.DEFAULT.DEP.FT'
        ...
        END
        IF Y.SYS.ID EQ 'TT' THEN
            Y.OR.ID = 'EB-MBL.TP.DEFAULT.DEP.TT'
            EB.DataAccess.FRead(FN.OR,Y.OR.ID,R.OVERRIDE,F.OR,E.OVERRIDE)
            Y.OVERR.ID = R.OVERRIDE<EB.OverrideProcessing.Override.OrMessage>
            Y.OVERR.ID.AC = Y.OVERR.ID:' ': Y.AC.NO
            EB.SystemTables.setText(Y.OVERR.ID.AC)
    ...
    ELSE
        ...
        IF Y.DEP.POS1 EQ 1 THEN
            ...
            Y.DEP.MAX.TXN.AMT = R.TP.REC<MB.TP.CASH.DEP.MAX>
            Y.DEP.TOT.AMT = R.TP.REC<MB.TP.CASH.DEP.AMT>
        ...
        IF Y.DEP.POS1 EQ 2 THEN
            ...
            Y.DEP.MAX.TXN.AMT = R.TP.REC<MB.TP.TRF.DEP.MAX>
            Y.DEP.TOT.AMT = R.TP.REC<MB.TP.TRF.DEP.AMT>
        ...
        IF Y.DEP.POS1 EQ 3 THEN
            ...
            Y.DEP.MAX.TXN.AMT = R.TP.REC<MB.TP.RMT.DEP.MAX>
            Y.DEP.TOT.AMT = R.TP.REC<MB.TP.RMT.DEP.AMT>
        ...
        IF Y.DEP.POS1 EQ 4 THEN
            ...
            Y.DEP.MAX.TXN.AMT = R.TP.REC<MB.TP.EXP.DEP.MAX>
            Y.DEP.TOT.AMT = R.TP.REC<MB.TP.EXP.DEP.AMT>
        ...
        IF Y.DEP.POS1 EQ 5 THEN
            ...
            Y.DEP.MAX.TXN.AMT = R.TP.REC<MB.TP.BOA.DEP.MAX>
            Y.DEP.TOT.AMT = R.TP.REC<MB.TP.BOA.DEP.AMT>
        ...
        IF Y.DEP.POS1 EQ 6 THEN
            ...
            Y.DEP.MAX.TXN.AMT = R.TP.REC<MB.TP.OTH.DEP.MAX>
            Y.DEP.TOT.AMT = R.TP.REC<MB.TP.OTH.DEP.AMT>
...
*******************
    IF Y.SYS.ID EQ 'FT' THEN
        ...
        IF Y.TOT.TXN.AMT GT Y.DEP.TOT.AMT THEN
            Y.OR.ID = 'EB-MBL.TP.TOT.AMT.DEP.FT'
            EB.DataAccess.FRead(FN.OR,Y.OR.ID,R.OVERRIDE,F.OR,E.OVERRIDE)
            Y.OVERR.ID = R.OVERRIDE<EB.OverrideProcessing.Override.OrMessage>
            Y.OVERR.ID.AC = Y.OVERR.ID:' ': Y.AC.NO
            EB.SystemTables.setText(Y.OVERR.ID.AC)
    ...
    IF Y.SYS.ID EQ 'TT' THEN
        ...
        IF Y.TOT.TXN.AMT GT Y.DEP.TOT.AMT THEN
            Y.OR.ID = 'EB-MBL.TP.TOT.AMT.DEP.TT'
            EB.DataAccess.FRead(FN.OR,Y.OR.ID,R.OVERRIDE,F.OR,E.OVERRIDE)
            Y.OVERR.ID = R.OVERRIDE<EB.OverrideProcessing.Override.OrMessage>
            Y.OVERR.ID.AC = Y.OVERR.ID:' ': Y.AC.NO
            EB.SystemTables.setText(Y.OVERR.ID.AC)
        ...
        END
    END
    Y.DATA = 'Y.AC.NO=':Y.AC.NO:'*':'Y.DEP.MAX.TXN.AMT=':Y.DEP.MAX.TXN.AMT:'*':'Y.DEP.TOT.TXN=':Y.DEP.TOT.TXN:'*':'Y.DEP.NO.TXN.MON=':Y.DEP.NO.TXN.MON:'*':'Y.TOT.TXN.AMT=':Y.TOT.TXN.AMT:'*':'Y.DEP.TOT.AMT=':Y.DEP.TOT.AMT
    Y.DIR = 'MBL.DATA'
    Y.FILE.NAME = 'TP'
    OPENSEQ Y.DIR,Y.FILE.NAME TO F.DIR THEN NULL
    WRITESEQ Y.DATA APPEND TO F.DIR ELSE
