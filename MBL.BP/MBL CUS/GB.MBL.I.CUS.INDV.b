* @ValidationCode : MjotOTgzNDM1MzAyOkNwMTI1MjoxNjIyNzAxOTI4NDA0OnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 Jun 2021 12:32:08
...
*                                                     FDS Pvt Ltd
*03/06/2021 -                             MODIFIED BY - TIPU
* STREET.1 is commented out.                          FDS BD
*                                         CHECKED BY  - MD Shibli Mollah
* STREET.1 is commented out.                          FDS BD
...
*******************
    IF Y.CUS.AD.VER EQ 'YES' THEN
        IF Y.CUS.AD.V.DET EQ Y.NULL THEN
            ...
            EB.SystemTables.setEtext("Enter How Address is Verified")
            EB.ErrorProcessing.StoreEndError()
        END
    END
